...
nouveau.addEventListener('click',() => {
    ...
    do {
        ...
        aleatoirVal = genererNombreEntier(citations.length)

    } while(aleatoirVal == dernier);


    citation.textContent = citations[aleatoirVal][0]
    auteur.textContent = citations[aleatoirVal][1]
    dernier = aleatoirVal

    console.log(aleatoirVal);
